  ...
  return (
    <div className=" shadow-lg max-w-sm p-6 bg-white border border-gray-200 rounded-lg  dar:bg-gray-800 dar:border-gray-700">
      ...
      <div className="btns flex gap-4">
        ...
        <button onClick={()=>navigate("/myFiles/3")}  className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-blue-700 border border-blue-700  rounded-lg  focus:ring-4 focus:outline-none focus:ring-blue-300 dar:bg-blue-600 dar:hover:bg-blue-700 dar:focus:ring-blue-800">Review <span onClick={(e)=>{e.stopPropagation();  window.open("/myFiles/3", "_blank"); }} className="ml-2"><FaArrowUpRightFromSquare/></span></button>
